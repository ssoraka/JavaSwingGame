...
public class TerminalView2 implements MyView2, Runnable {
    ...
    private AllController2 controllers;
    ...
    public TerminalView2(ModelView model, AllController2 controllers) {
        this.model = model;
